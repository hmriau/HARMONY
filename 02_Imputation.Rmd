...
imp <- mice(imputedat_t, m = 20, print = FALSE,method="pmm",maxit=50,seed=930320491,
            pred=quickpred(imputedat_t,include=c("treatment","redcap_data_access_group","atop_cannabis_used"),
                           exclude=c("hsi2_day_baseline","hsi2_day_w4","hsi2_day_w8","hsi2_day_w12","hsi2_day_w24"), #this was done well after report sent so not included as predictor
...
plot(imp, hsi2_day_w4 + hsi2_day_w8 + hsi2_day_w12 + hsi2_day_w24 ~ .it | .ms, layout = c(2, 1))
```

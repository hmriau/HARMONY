...
remove then to show that the results are similar
```{r}
...
Need to determine if the prior for control should include only those who were abstinent at baseline. Currently only defines the intercept (b[1]) so its also kind of giving a prior for non-cannabis users?
```{r}
